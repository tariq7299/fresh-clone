...
export default async function AppointmentsTableWrapper({ searchParams, dict, lang }: { searchParams: AppointmentPageQueries, dict: Dictionary, lang: "en" | "ar" }) {
    ...
    return <AppointmentsTable appointments={appointments} pagination={pagination} dict={dict} lang={lang} />
