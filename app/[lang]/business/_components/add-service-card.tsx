...
export function AddServiceCard({ service }: { service: ApiService }) {
    ...
    return <div onClick={handleClickingService} className={cn("flex justify-between items-center w-full md:border border-gray-200 md:rounded-lg p-4 md:p-5 border-b pb-4 cursor-pointer hover:bg-accent/10 group transition-colors duration-150 ", checked ? "bg-accent/5 ring-2 ring-accent text-accent-600 rounded-lg" : "")} >
