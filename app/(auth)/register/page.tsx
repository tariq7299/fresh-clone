...
export default async function RegisterPage(props: {
    ...
    return (
        ...
        <div className="mt-auto flex flex-col gap-2 w-full max-w-md p-5 pt-20">
            ...
            <p className="text-muted-foreground text-sm text-center pb-4">{type === "professional" ? "Create your account and streamline your salon management today." : "Create your account and book salons and spas near you today."}</p>
